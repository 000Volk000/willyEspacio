...
(defrule moverWilly (declare (salience 0))
    (directions $? ?dir $?)
    ?h <- (hice ?x)
    ?act <- (act algo)
    =>
...
(defrule DispararEastDown (declare (salience 10000))
   (percepts Noise)
   (hasLaser)
   (pos ?x1 ?y1)
   (directions $? east $?)
...
(defrule DispararEastRight (declare (salience 10000))
   (percepts Noise)
   (hasLaser)
   (pos ?x1 ?y1)
   (directions $? east $?)
...
(defrule DispararEastUp (declare (salience 10000))
   (percepts Noise)
   (hasLaser)
   (pos ?x1 ?y1)
   (directions $? east $?)
...
(defrule DispararWestDown (declare (salience 10000))
   (percepts Noise)
   (hasLaser)
   (pos ?x1 ?y1)
   (directions $? west $?)
...
(defrule DispararWestRight (declare (salience 10000))
   (percepts Noise)
   (hasLaser)
   (pos ?x1 ?y1)
   (directions $? west $?)
...
(defrule DispararEWestUp (declare (salience 10000))
   (percepts Noise)
   (hasLaser)
   (pos ?x1 ?y1)
   (directions $? west $?)
...
(defrule DispararSouthRight (declare (salience 10000))
   (percepts Noise)
   (hasLaser)
   (pos ?x1 ?y1)
   (directions $? south $?)
...
(defrule DispararNSouthLeft (declare (salience 10000))
   (percepts Noise)
   (hasLaser)
   (pos ?x1 ?y1)
   (directions $? south $?)
...
(defrule DispararSouthUp (declare (salience 10000))
   (percepts Noise)
   (hasLaser)
   (pos ?x1 ?y1)
   (directions $? south $?)
